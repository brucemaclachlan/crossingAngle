...
arrayX=numpy.array(MHCxminusxbar, dtype=float)
#print arrayX
arrayY=numpy.array(MHCyminusybar, dtype=float)
#print arrayY
arrayZ=numpy.array(MHCzminuszbar)
#print arrayZ
